...
import dungeonmania.entities.powerables.logicstrategies.LogicFactory;
...
public class EntityFactory {
    ...
    private Entity constructEntity(JSONObject jsonEntity, JSONObject config) {
        ...
        case "bomb":
            ...
            String logicTypeBomb = jsonEntity.optString("logic", null);
            if (logicTypeBomb != null) {
                return new LogicBomb(pos, bombRadius, logicFactory.createLogicStrategy(logicTypeBomb));
            }
        ...
        case "door":
            return new KeyDoor(pos, jsonEntity.getInt("key"));
        case "key":
            return new Key(pos, jsonEntity.getInt("key"));
        case "sun_stone":
            return new SunStone(pos);
        case "switch_door":
            String logicTypeDoor = jsonEntity.optString("logic", null);
            return new SwitchDoor(pos, logicFactory.createLogicStrategy(logicTypeDoor));
        case "light_bulb_off":
            String logicTypeBulb = jsonEntity.optString("logic", null);
            return new LightBulb(pos, logicFactory.createLogicStrategy(logicTypeBulb));
        case "wire":
            return new Wire(pos);
        default:
            return null;
